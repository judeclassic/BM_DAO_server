...
import RaiderUserServiceService from "./chatter_service.service";
import RaiderServiceValidator from "./chatter_service.validator";
...
export default ChatterUserServiceController;