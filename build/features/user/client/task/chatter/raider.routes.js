...
const chatter_client_service_1 = __importDefault(require("./chatter.client.service"));
...
const useClientRaidersTaskRoutes = ({ router }) => {
    ...
    const raiderTaskService = new chatter_client_service_1.default({ raiderTaskModel, userModel, raiderServiceModel, transactionModel });
