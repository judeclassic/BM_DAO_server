...
const chatters_dto_1 = __importStar(require("../../../../../types/dtos/service/chatters.dto"));
...
exports.UserService = (0, mongoose_1.model)("ChatterService", RaiderUserServiceSchema);
class ChatterUserServiceModel {
    constructor() {
        this.createUserService = (details) => __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.UserService.create(details);
                if (data) {
                    return { status: true, data: new chatters_dto_1.default(data) };
                }
                else {
        ...
        this.updateCreatedAnalytics = (userId) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    ...
                    return { status: true, data: new chatters_dto_1.default(updatedUser !== null && updatedUser !== void 0 ? updatedUser : data) };
                }
                else {
        ...
        this.getAllUserService = (details, option) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    return { status: true,
                        data: new chatters_dto_1.MultipleChatterUserServiceDto({
        ...
        this.getAllUserServices = (details) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    return { status: true, data: data.map((service) => new chatters_dto_1.default(service)) };
                }
                else {
                    return { status: false, error: "Couldn't get store details" };
                }
...
exports.default = ChatterUserServiceModel;
