...
exports.ModeratorUserService = void 0;
...
class ModeratorUserServiceModel {
    constructor() {
        ...
        this.getAllUserService = (details, option) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    return { status: true,
                        data: new moderators_dto_1.MultipleModeratorServiceDto({
        ...
        this.getAllUserServices = (details) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    return { status: true, data: data.map((service) => new moderators_dto_1.default(service)) };
                }
                else {
                    return { status: false, error: "Couldn't get store details" };
                }
        ...
        this.UserService = exports.ModeratorUserService;
    }
}
exports.default = ModeratorUserServiceModel;
