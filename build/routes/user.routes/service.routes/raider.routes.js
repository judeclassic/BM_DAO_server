...
const raiders_controller_1 = __importDefault(require("../../../domain/controllers/service.controller/raiders.controller"));
const user_service_validator_1 = __importDefault(require("../../../domain/validators/user_service.validator"));
const raider_service_1 = __importDefault(require("../../../domain/services/user.service/services/raider.service"));
...
const useRaiderUserServicesRoutes = ({ router }) => {
    ...
    const userServiceService = new raider_service_1.default({ authRepo, userModel, userServiceModel });
    const userServiceController = new raiders_controller_1.default({ userServiceValidator, userServiceService });
