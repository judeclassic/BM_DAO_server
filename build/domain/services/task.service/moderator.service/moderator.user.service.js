...
class ModeratorUserTaskService {
    constructor({ raiderTaskModel, userModel, raidModel, raiderServiceModel, moderatorServiceModel }) {
        ...
        this.getAllModeratorTask = (userId, option) => __awaiter(this, void 0, void 0, function* () {
            const tasksResponse = yield this._raiderTaskModel.getActiveTask({ moderatorId: userId }, option);
            if (!tasksResponse.data)
                return { errors: [ERROR_GETING_ALL_USER_TASKS] };
            return { tasks: tasksResponse.data };
        });
        ...
        this.getRaidersRaid = (taskId, option) => __awaiter(this, void 0, void 0, function* () {
