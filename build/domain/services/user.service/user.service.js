...
class UserService {
    constructor({ mailRepo, authRepo, userModel }) {
        this.createUser = ({ accountType, name, username, emailAddress, password, referalCode }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const userDto = new user_dto_1.default(user.data);
            const accessToken = this._authRepo.encryptToken(userDto.getUserForToken, auth_1.TokenType.accessToken);
        ...
        this.updateProfileInformation = (userId, { name, emailAddress, phoneNumber, country }) => __awaiter(this, void 0, void 0, function* () {
            const user = yield this._userModel.checkIfExist({ _id: userId });
            if (user.error || !user.data)
                return { errors: [ERROR_USER_NOT_FOUND] };
            if (emailAddress && emailAddress !== user.data.emailAddress) {
                const userWithEmailExists = yield this._userModel.checkIfExist({ emailAddress });
                if (userWithEmailExists.data) {
                    return { errors: [ERROR_USER_ALREADY_EXISTS_WITH_EMAIL] };
                }
            ...
            const finalUser = yield this._userModel.updateUserDetailToDB(user.data.id, {
                ...
                emailAddress: emailAddress !== null && emailAddress !== void 0 ? emailAddress : user.data.emailAddress,
            ...
            return { user: new user_dto_1.default(finalUser.data) };
        });
        ...
        this.findUserByEmail = (emailAddress) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new user_dto_1.default(user.data);
        });
