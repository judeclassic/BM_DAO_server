...
class AuthController {
    constructor({ authValidator, userService }) {
        this.registerUser = ({ body }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            const validationErrors = this._authValidator.validateBuyerBeforeRegistration(Object.assign({}, body));
            ...
            const { user, errors } = yield this._userService.createUser({ name, emailAddress, username, password, country, accountType, referalCode });
        ...
        this.loginUser = ({ body }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            const validationErrors = this._authValidator.login(Object.assign({}, body));
            if (validationErrors.length > 0) {
                return sendJson(403, { code: 403, status: false, error: validationErrors });
            }
            const { emailAddress, password } = body;
            const response = yield this._userService.loginUser({ emailAddress, password });
            if (!response.user)
                return sendJson(403, {
                    status: false,
                    code: 403,
        ...
        this.resetPassword = ({ body }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            const { email } = body;
            const validationErrors = this._authValidator.resetPassword(Object.assign({}, body));
            if (validationErrors.length > 0)
                return sendJson(400, {
                    status: false,
                    code: 400,
            ...
            yield this._userService.resetPassword(email);
            return sendJson(201, {
                status: true,
                code: 201,
            });
        ...
        this.confirmResetPassword = ({ body }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            ...
            const validationErrors = this._authValidator.confirmResetPassword({ emailAddress, code, password, confirmPassword });
            if (validationErrors.length > 0)
                return sendJson(400, {
                    status: false,
                    code: 400,
            ...
            const errors = yield this._userService.confirmResetPassword(code, password);
            if (errors != null)
        ...
        this.logout = ({ body, user }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._userService.logoutUser(user.id);
