...
class UserController {
    constructor({ userService, userValidator }) {
        ...
        this.updateProfile = ({ user, body }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { name, emailAddress, phoneNumber, country } = body;
            const foundUser = yield this._userService.updateProfileInformation(id, { name, emailAddress, phoneNumber, country });
            if (foundUser === null) {
                return sendJson(401, {
                    error: [{ message: 'User is not found' }],
                    status: false,
