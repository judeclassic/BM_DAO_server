...
class ClientRaidController {
    constructor({ taskValidator, raiderTaskService }) {
        this.createRaidTask = ({ body, user }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            const validationErrors = this._taskValidator.validateBeforeRaiderGigCreation(Object.assign({}, body));
            ...
            const response = yield this._raiderClientTaskService.createRaidTask(user.id, body);
            if (!response.tasks)
                return sendJson(401, {
        ...
        this.createTask = ({ body, user }, sendJson) => __awaiter(this, void 0, void 0, function* () {
            const validationErrors = this._taskValidator.validateBeforeRaiderTaskCreation(Object.assign({}, body));
            if (validationErrors.length > 0) {
                return sendJson(400, {
                    error: validationErrors,
                    code: 400,
